...
[![OpenSSF Best Practices](https://bestpractices.coreinfrastructure.org/projects/10072/badge)](https://bestpractices.coreinfrastructure.org/projects/10072)
...
```bash
docker buildx imagetools inspect leplusorg/pdf --format '{{ json .Provenance }}'
```
